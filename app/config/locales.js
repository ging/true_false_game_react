export let LOCALES = {
  ...
  es:{
    ...
    "i.finish_screen_title_full":"El contenido ha terminado. Utilice el botón 'Salir de la actividad' que está situado en Moodle por encima de esta aplicación para volver al curso. Su progreso final fue #{progress_measure}% y su puntuación final fue #{score}%.",
    "i.finish_screen_title_wpm":"El contenido ha terminado. Utilice el botón 'Salir de la actividad' que está situado en Moodle por encima de esta aplicación para volver al curso. Su progreso final fue #{progress_measure}%.",
    "i.finish_screen_title_ws":"El contenido ha terminado. Utilice el botón 'Salir de la actividad' que está situado en Moodle por encima de esta aplicación para volver al curso. Su puntuación final fue #{score}%.",
