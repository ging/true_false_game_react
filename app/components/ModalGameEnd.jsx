              ...
              <div className="modal-title modal-title-end">¡enhorabuena! terminaste</div>
                <div className="modal-text">
                  ...
                  <div className="responsive_video">
                    <iframe ref={(youtube) => { this.youtube = youtube; }} width="560" height="315" src={this.props.data.final_video} frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
                  </div>
                </div>
